...
export const PART_ZH: Record<string, string> = {
  ...
  panel_40x40_sensory: '感官垫 40×40（兼容件）',
  panel_40x40_pocket: '布兜 40×40（兼容件）',
  panel_40x40_basin: '感官盆 40×40（兼容件）',
  textile_rainbow: '彩虹带（兼容件）',
  textile_bridge: '彩虹桥（兼容件）',
  sleeve: '软包滚筒（兼容件）',
...
export const PART_EN: Record<string, string> = {
  ...
  panel_40x40_sensory: 'Sensory mat 40×40 (compatible)',
  panel_40x40_pocket: 'Cloth pocket 40×40 (compatible)',
  panel_40x40_basin: 'Sensory basin 40×40 (compatible)',
  textile_rainbow: 'Rainbow strip (compatible)',
  textile_bridge: 'Rainbow bridge (compatible)',
  sleeve: 'Tube sleeve (compatible)',
...
export const PART_DE: Record<string, string> = {
  ...
  panel_40x40_sensory: 'Sensorikmatte 40×40 (kompatibel)',
  panel_40x40_pocket: 'Stofftasche 40×40 (kompatibel)',
  panel_40x40_basin: 'Sensorikwanne 40×40 (kompatibel)',
  textile_rainbow: 'Regenbogenband (kompatibel)',
  textile_bridge: 'Regenbogenbrücke (kompatibel)',
  sleeve: 'Rohrpolster (kompatibel)',
