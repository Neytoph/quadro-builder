...
export const PART_ZH: Record<string, string> = {
  ...
  acrylic_panel_40x40: '透明窗板 40×40 cm',
  panel_40x40_lego: '乐高板 40×40（兼容件）',
  panel_40x40_basketball: '篮球板 40×40（兼容件）',
  panel_40x40_honeycomb: '蜂窝板 40×40（兼容件）',
  panel_40x40_busy: '忙碌板 40×40（兼容件）',
  panel_40x40_felt: '毛毡板 40×40（兼容件）',
  panel_40x40_magnet: '磁吸板 40×40（兼容件）',
  panel_40x40_climbing: '攀岩板 40×40（兼容件）',
  acrylic_glass: '亚克力片 35×35 cm',
  panel_70x120: '板 70×120 cm',
  reinforce80: '加固杆 80 cm',
  safety_clamp: '地锚夹',
  screw_tube: '管螺丝',
  screw_panel: '板螺丝',
  screw_acrylic: '亚克力螺丝',
...
export const PART_EN: Record<string, string> = {
  ...
  acrylic_panel_40x40: 'Acrylic window panel 40×40 cm',
  panel_40x40_lego: 'Lego panel 40×40 (compatible)',
  panel_40x40_basketball: 'Basketball panel 40×40 (compatible)',
  panel_40x40_honeycomb: 'Honeycomb panel 40×40 (compatible)',
  panel_40x40_busy: 'Busy board panel 40×40 (compatible)',
  panel_40x40_felt: 'Felt panel 40×40 (compatible)',
  panel_40x40_magnet: 'Magnetic panel 40×40 (compatible)',
  panel_40x40_climbing: 'Climbing panel 40×40 (compatible)',
  acrylic_glass: 'Acrylic sheet 35×35 cm',
  panel_70x120: 'Panel 70×120 cm',
  reinforce80: 'Tube core 80 cm',
  safety_clamp: 'Ground clamp',
  screw_tube: 'Tube screw',
  screw_panel: 'Panel screw',
  screw_acrylic: 'Acrylic screw',
...
export const PART_DE: Record<string, string> = {
  ...
  acrylic_panel_40x40: 'Acrylglasplatte 40×40 cm',
  panel_40x40_lego: 'Lego-Platte 40×40 (kompatibel)',
  panel_40x40_basketball: 'Korbplatte 40×40 (kompatibel)',
  panel_40x40_honeycomb: 'Wabenplatte 40×40 (kompatibel)',
  panel_40x40_busy: 'Busy-Board-Platte 40×40 (kompatibel)',
  panel_40x40_felt: 'Filzplatte 40×40 (kompatibel)',
  panel_40x40_magnet: 'Magnetplatte 40×40 (kompatibel)',
  panel_40x40_climbing: 'Kletterplatte 40×40 (kompatibel)',
  acrylic_glass: 'Acrylglas 35×35 cm',
  panel_70x120: 'Platte 70×120 cm',
  reinforce80: 'Verstärkung 80 cm',
  safety_clamp: 'Bodenanker',
  screw_tube: 'Rohrschraube',
  screw_panel: 'Plattenschraube',
  screw_acrylic: 'Acrylglasschraube',
